...
public class Game {
    ...
    printDramaticText("⠀⠀⠀⠀⠀⠀⠀⠀⣀⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\n⠀⠀⠀⠀⠀⠀⣰⣿⣿⣿⣿⣦⣀⣀⣀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀\n⠀⠀⠀⠀⠀⠀⢿⣿⠟⠋⠉⠀⠀⠀⠀⠉⠑⠢⣄⡀⠀⠀⠀⠀⠀\n⠀⠀⠀⠀⠀⢠⠞⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠙⢿⣿⣿⣦⡀\n⠀⣀⠀⠀⢀⡏⠀⢀⣴⣶⣶⡄⠀⠀⠀⠀⠀⠀⠀⠀⠀⢻⣿⣿⠇\n⣾⣿⣿⣦⣼⡀⠀⢺⣿⣿⡿⠃⠀⠀⠀⠀⣠⣤⣄⠀⠀⠈⡿⠋⠀\n⢿⣿⣿⣿⣿⣇⠀⠤⠌⠁⠀⡀⢲⡶⠄⢸⣏⣿⣿⠀⠀⠀⡇⠀⠀                      Welcome to your first\n⠈⢿⣿⣿⣿⣿⣷⣄⡀⠀⠀⠈⠉⠓⠂⠀⠙⠛⠛⠠⠀⡸⠁⠀⠀                       day of a new school\n⠀⠀⠻⣿⣿⣿⣿⣿⣿⣷⣦⣄⣀⠀⠀⠀⠀⠑⠀⣠⠞⠁⠀⠀⠀                       year at St. Saviour!!!\n⠀⠀⠀⢸⡏⠉⠛⠛⠛⠿⠿⣿⣿⣿⣿⣿⣿⣿⣿⡄⠀⠀⠀⠀⠀\n⠀⠀⠀⠸⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⠛⢿⣿⣿⣿⣿⡄⠀⠀⠀⠀\n⠀⠀⠀⢷⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⢻⣿⣿⣿⣿⡀⠀⠀⠀\n⠀⠀⠀⢸⣆⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⣿⣿⣿⣿⡇⠀⠀⠀\n⠀⠀⠀⢸⣿⣦⣀⠀⠀⠀⠀⠀⠀⠀⠀⢀⣼⡟⠻⠿⠟⡀⠀⠀⠀\n⠀⠀⠀⠀⣿⣿⣿⣿⣶⠶⠤⠤⢤⣶⣾⣿⣿⡇⠀⠀⠀⠀⠀⠀⠀\n⠀⠀⠀⠀⠹⣿⣿⣿⠏⠀⠀⠀⠈⢿⣿⣿⡿⠁⠀⠀⠀⠀⠀⠀⠀\n⠀⠀⠀⠀⠀⠈⠉⠉⠀⠀⠀⠀⠀⠀⠉⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀");
        ...
        // Allow the player to write their stats as long as it does not exceed the 9 skill points they have
        int skillpoints = 9;
    ...
    // Provides a bous to one stat depending on the player's grade
    ...
    // Displays the player's stats before starting the game
    ...
    // First encounter. Provides different outcomes based on the user's choice.
    ...
    if (choice1.equals("a") || choice1.equals("A")){
        ...
        // Implements a dice roll to give the player a 50/50 chance of getting the question right. If they roll 1, 2, or 3, they get it wrong. If the user has high intellect, they get a slight advantage in this dice roll which adds 1 to the outcome and makes it more likely for it to end up greater than 3.
        ...
        // Quick time event. Gives the user 10 seconds to type in a specific word and causes the player to lose agility and aura if they type the wrong word or let the timer run out.
        ...
        // Rolls a die when the player chooses A in order to give the player a 50/50 chace at succeeding in this encounter. If the user has high agility, they gain a slight advantage in this dice roll.
        ...
        printDramaticText("");
        // Quick time event. Adds 1 intelligence to the user's stats if they answer correctly and within 10 seconds.
        printDramaticText("!!!QUICK TIME EVENT!!!");
        ...
        }else if(qt2.equals("mitochondria")) {
            printDramaticText("Congrats! You passed the pop quiz! \n +1 Intelligence");
        }else{
            // Implementing a chance for the player to win regardless of wrong input but only if their intelligence stat is high
            if (intelligence >= 3){
    ...
    // Evaluates the stats once the day is over
    printDramaticText("\n\nThe day has ended. Here are your stats. \n Agility: " + agility + "\n Intelligence: " + intelligence + "\n Aura: " + aura + "\n Experience: " + experience );        
    //Prints a victory message if all stats >0 or prints a Game over message otherwise.
